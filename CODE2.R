...
#Checking the proportion of loan defaulters
...
#Dropping these variables as it is mostly of one level and hence adds no value to predicting target variable
...
# I am going to delete all the columns with greater than 60% missing values.
